...
/// Sidebar state: session list and navigation cursor.
...
impl SidebarState {
    ...
    pub fn refresh(
        ...
        // Release badges for removed sessions.
...
pub fn render_sidebar(
    ...
    for (i, entry) in visible {
        ...
        let line = Line::from(vec![
            Span::styled(&entry.badge, theme.accent),
            Span::raw(" "),
            Span::styled(&entry.host, theme.muted),
            Span::raw(" "),
